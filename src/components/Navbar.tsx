  ...
  return (
    <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-sm border-b border-[#cce0f5]">
      <div className="bg-[#005fc5] text-white text-xs py-1.5 px-4 flex justify-between items-center">
        <span>Serving Lahore, Islamabad, Multan, Peshawar, Quetta & Faisalabad</span>
        <a href="tel:+923117792837" className="hidden sm:block hover:underline">
          0311-779-2837
        </a>
      </div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between h-16">
        <Link to="/" className="flex items-center gap-2.5 group" aria-label="RS Waters home">
          ...
          <div className="leading-none">
            ...
            <div className="text-[10px] text-[#4a6080] font-medium tracking-wide uppercase">Water Solutions</div>
          </div>
        </Link>
